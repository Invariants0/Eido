...
import { BackendSessionSync } from '@/components/auth/BackendSessionSync';
...
export const metadata: Metadata = {
  ...
  description:
    'Eido is an autonomous startup builder that discovers problems, builds MVPs, deploys them, and seeks funding.',
};
