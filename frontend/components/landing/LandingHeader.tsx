...
export function LandingHeader() {
  return (
    <header className="fixed top-0 w-full z-50 flex items-center justify-between px-4 md:px-6 py-4 bg-black/50 backdrop-blur-lg border-b border-white/5">
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/dashboard"
          className="px-3 md:px-5 py-2 text-xs md:text-sm font-medium bg-white text-black rounded-full hover:bg-zinc-200 transition-colors shadow-lg shadow-white/5"
        >
          Enter Console
        </Link>
