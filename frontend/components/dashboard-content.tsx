...
const projects = [
  {
    ...
    status: 'Deployed',
    description: 'Autonomous invoice management for freelancers — built end-to-end in 55s.',
    token: 'INVC',
    tokenPrice: '$0.042',
    investors: 1,
    progress: 100,
  },
  {
    ...
    name: 'EcoRewards App',
    status: 'Building',
    description: 'Gamified recycling rewards platform with token incentives.',
    token: 'ECO',
    tokenPrice: '$0.015',
    investors: 0,
    progress: 48,
  },
  {
    ...
    name: 'Voice-to-CRM',
    status: 'Idea',
    description: 'Transcribes voice notes directly into Salesforce records.',
    token: 'PENDING',
    tokenPrice: '-',
    investors: 0,
    progress: 5,
